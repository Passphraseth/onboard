...
export default function PrivacyPage() { return <LegalPage title={title} description={description} path="/privacy">
  ...
  <section><h2>Email processing</h2><p>Form submissions and acknowledgement messages are processed through the website’s configured transactional email provider. Do not submit information that is not necessary for the proposed acquisition.</p></section>
