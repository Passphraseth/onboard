    ...
    try {
      ...
      if (response.ok) {
        ...
        if (typeof window !== 'undefined' && (window as unknown as { gtag?: (...args: unknown[]) => void }).gtag) {
          (window as unknown as { gtag: (...args: unknown[]) => void }).gtag('event', 'lead_conversion', {
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="What's your biggest concern about your online presence?"
                      />
                    </div>
              ...
              <div className="bg-neutral-900 rounded-xl p-6 mb-8">
                ...
                <div className="text-left space-y-3 text-neutral-300 text-sm">
                  <div className="flex gap-3">
                    ...
                    <span>I&apos;ll check your current online presence</span>
                  </div>
                  <div className="flex gap-3">
