...
export default function ROICalculatorPage() {
  ...
  useEffect(() => {
    ...
    const onlineOpportunity = currentJobs * 0.87 * 0.3 // 87% search online, 30% could be captured
    const annualValue = onlineOpportunity * data.averageJobValue * 12
    const websiteROI = (annualValue / (49 * 12)) * 100 // $49/month vs annual opportunity
        ...
        <main className="pt-24 pb-16">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <label className="block text-sm text-neutral-400 mb-3">
                          Do you currently have a professional website?
                        </label>
          ...
          {!submitted && (
            <section className="section bg-neutral-950">
              <div className="container max-w-4xl">
                <h2 className="text-2xl font-semibold text-center mb-8">Why This Matters</h2>
                
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center p-6">
                    <div className="text-3xl mb-4">🔍</div>
                    <h3 className="font-semibold mb-2">87% Search Online</h3>
                    <p className="text-neutral-400 text-sm">Before hiring any service provider, customers search online first</p>
                  </div>
                  
                  <div className="text-center p-6">
                    <div className="text-3xl mb-4">💰</div>
                    <h3 className="font-semibold mb-2">Higher Value Jobs</h3>
                    <p className="text-neutral-400 text-sm">Online customers often have bigger budgets and higher-value projects</p>
                  </div>
                  
                  <div className="text-center p-6">
                    <div className="text-3xl mb-4">⚡</div>
                    <h3 className="font-semibont mb-2">24/7 Lead Generation</h3>
                    <p className="text-neutral-400 text-sm">Your website works even while you sleep, capturing opportunities</p>
                  </div>
                </div>
              </div>
            </section>
